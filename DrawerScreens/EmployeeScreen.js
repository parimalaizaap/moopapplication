...
const swipeBtns =(temp) =>  [
  {
  text: 'Delete',
  backgroundColor: 'red',
  underlayColor: 'rgba(0, 0, 0, 1, 0.6)',
  onPress: () => { 
    const filteredData = masterDataSource.filter(item => item.id !== temp.id);
...
},
{
  ...
  underlayColor: 'rgba(0, 0, 0, 1, 0.6)',
  onPress: () => {
    props.navigation.navigate('AddUpdatePage');
    }
}
...
false?   <Text style={styles.txt}>Current Orders</Text>: null}
 </View>       
        <FlatList
